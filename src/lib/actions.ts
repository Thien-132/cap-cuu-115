            ...
            <div style="padding: 30px 40px;">
              ...
              <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 24px; margin-bottom: 30px;">
                <table style="width: 100%; border-collapse: collapse;">
                  ...
                  ${serviceType ? `<tr><td style="padding: 10px 0; border-bottom: 1px dashed #cbd5e1; color: #64748b; font-size: 14px;">🚑 Loại dịch vụ</td><td style="padding: 10px 0; border-bottom: 1px dashed #cbd5e1; color: #0284c7; font-size: 15px; font-weight: 700; text-align: right;">${serviceType}</td></tr>` : ""}

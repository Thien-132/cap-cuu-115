...
export const Route = createFileRoute('/lien-he')({
  head: () => ({
    meta: [
      { title: 'Liên hệ — Cấp cứu 115 Hồng Hải' },
      { name: 'description', content: 'Thông tin liên hệ của trung tâm Cấp cứu 115 Hồng Hải.' },
    ],
  }),
...
function PageComponent() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar alwaysDark onOpenBooking={() => setBookingOpen(true)} subtitle="Liên hệ" navItems={NAV} />
      <main className="pt-32 pb-16 min-h-[80vh]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeading eyebrow="Dịch vụ" title="Liên hệ" subtitle="Thông tin liên hệ của trung tâm Cấp cứu 115 Hồng Hải." />

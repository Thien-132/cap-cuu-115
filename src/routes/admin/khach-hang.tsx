          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-secondary/40 text-muted-foreground border-b border-border">
              <tr>
                ...
                <th className="whitespace-nowrap px-6 py-4 font-semibold text-center">Hoàn thành</th>
                ...
                <th className="whitespace-nowrap px-6 py-4 font-semibold text-center">Trạng thái chặn</th>
                <th className="whitespace-nowrap px-6 py-4 font-semibold text-right">Thao tác</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {history.length === 0 ? (
                <tr><td colSpan={6} className="whitespace-nowrap px-6 py-12 text-center text-muted-foreground">Chưa có dữ liệu khách hàng.</td></tr>
              ) : history.map((record) => (

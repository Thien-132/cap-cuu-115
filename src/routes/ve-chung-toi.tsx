...
export const Route = createFileRoute('/ve-chung-toi')({
  head: () => ({
    meta: [
      { title: 'Về chúng tôi — Cấp cứu 115 Hồng Hải' },
      { name: 'description', content: 'Giới thiệu về trung tâm Cấp cứu 115 Hồng Hải.' },
    ],
  }),
...
function PageComponent() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar alwaysDark onOpenBooking={() => setBookingOpen(true)} subtitle="Về chúng tôi" navItems={NAV} />
      <main className="pt-32 pb-16 min-h-[80vh]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeading eyebrow="Dịch vụ" title="Về chúng tôi" subtitle="Giới thiệu về trung tâm Cấp cứu 115 Hồng Hải." />

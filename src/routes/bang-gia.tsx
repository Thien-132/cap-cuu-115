...
export const Route = createFileRoute('/bang-gia')({
  head: () => ({
    meta: [
      { title: 'Bảng giá dịch vụ — Cấp cứu 115 Hồng Hải' },
      { name: 'description', content: 'Bảng giá cước vận chuyển và dịch vụ y tế minh bạch.' },
    ],
  }),
...
function PageComponent() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar alwaysDark onOpenBooking={() => setBookingOpen(true)} subtitle="Bảng giá dịch vụ" navItems={NAV} />
      <main className="pt-32 pb-16 min-h-[80vh]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeading eyebrow="Dịch vụ" title="Bảng giá dịch vụ" subtitle="Bảng giá cước vận chuyển và dịch vụ y tế minh bạch." />

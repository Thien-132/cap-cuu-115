...
export const Route = createFileRoute("/van-chuyen-y-te")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Đưa đón bệnh nhân chuyển tuyến, ra viện, đi khám bệnh an toàn.",
      },
    ],
  }),
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeading
                ...
                subtitle="Đưa đón bệnh nhân chuyển tuyến, ra viện, đi khám bệnh an toàn."
              />
